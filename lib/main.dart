...
class _MainAppState extends State<MainApp>{
  ...
  static const Color _roxo = Color(0xFF00695C);
  static const Color _roxoClaro = Color(0xFFE0F2F1);
  static const Color _roxoMedia = Color(0xFFB2DFDB);
  static const Color _cinza = Color(0xFF546E7A);
